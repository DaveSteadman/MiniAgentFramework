...
## Purpose
Read already-mined content from the 01-Mine research stage and produce a structured daily
intelligence summary using an LLM call. Saves the result to the 02-Analysis stage.

The skill makes its own internal LLM call - the agent's confirmation response will be a
short "Saved: ..." string, not the full analysis text.
